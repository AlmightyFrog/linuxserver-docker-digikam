...
Intention is to gain some more time thinking about my future setup (e.g. RDP use case) without losing security updates.
...
Changed to linuxserver/rdesktop:arch-openbox which does not provide webservice anymore.
---
